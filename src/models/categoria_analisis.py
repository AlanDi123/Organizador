...
from src.utils.math_utils import calcular_media, calcular_desviacion_estandar, obtener_rango
    ...
    def mostrar_estadisticas(self):
        ...
        for i, stat in enumerate(stats):
            card = tk.Frame(
                ...
                bg=self.controller.colores['claro']['panel'],
                # highlightbackground=  # No soportado en este tema Linux, stat["color"],
